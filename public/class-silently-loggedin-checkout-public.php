...
class Silently_Loggedin_Checkout_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/silently-loggedin-checkout-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/silently-loggedin-checkout-public.js', array( 'jquery' ), $this->version, false );
